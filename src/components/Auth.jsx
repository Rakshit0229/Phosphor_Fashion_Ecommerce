...
const Auth = ({ mode = 'login' }) => {
      ...
      if (isSignup) {
        ...
        if (signInError) {
          if (signInError.message.includes('Invalid login credentials')) {
            setError('Invalid email or password. If you signed up with localStorage before, please sign up again with InsForge using the same email.');
          } else {
  ...
  const handleGitHubSignIn = async () => {
    setError('GitHub OAuth is not configured. Please use email/password signup.');
  };
      ...
      <div className="auth-card">
        ...
        <p className="auth-switch">
          ...
          <button 
            ...
            style={{ background: 'none', border: 'none', color: '#c9a84c', cursor: 'pointer', textDecoration: 'underline', padding: 0, font: 'inherit' }}
          >
